          ...
          <div className="flex flex-col gap-[41px] justify-start w-full">
            <div className="bg-white-A700 flex flex-row items-start justify-start md:px-10 sm:px-5 px-[689px] shadow-bs5 w-auto md:w-full">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-center w-full">
                ...
                <Button
                  className="!text-gray-900_01 cursor-pointer font-medium min-w-[196px] shadow-bs19 text-base text-center"
                  shape="square"
                  color="white_A700"
                  size="xl"
                  variant="fill"
              ...
              >
                <div className="flex flex-col gap-3 items-start justify-start my-0 w-auto md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-0.5 items-start justify-start ml-3 md:ml-[0] w-[119px]">
                      ...
                      <Img
                        className="h-4 w-20"
                        src="images/img_rating_orange_600.svg"
                        alt="close"
                      />
                    </div>
                    <Text
                      className="md:ml-[0] ml-[516px] md:mt-0 mt-[11px] text-gray-500 text-right text-sm"
                ...
                <div className="flex flex-col gap-3 items-start justify-start my-0 w-auto md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <Text
                      className="md:ml-[0] ml-[520px] md:mt-0 mt-[11px] text-gray-500 text-right text-sm"
                      size="txtPoppinsRegular14"
                    >
                      30 Apr, 2021
                    </Text>
                ...
                <div className="flex flex-col gap-3 items-start justify-start my-0 w-auto md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <Text
                      className="md:ml-[0] ml-[546px] md:mt-0 mt-[11px] text-gray-500 text-right text-sm"
                      size="txtPoppinsRegular14"
                    >
                      2 min ago
                    </Text>
                ...
                <div className="flex flex-col gap-3 items-start justify-start my-0 w-auto md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <Text
                      className="md:ml-[0] ml-[531px] md:mt-0 mt-[11px] text-gray-500 text-right text-sm"
                      size="txtPoppinsRegular14"
                    >
                      2 min ago
                    </Text>
